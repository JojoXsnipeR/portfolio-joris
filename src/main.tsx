                    ...
                    <div className="container hero-container">
                        <div className="hero-content">
                            ...
                            <div className="hero-cta" style={{ display: "flex", justifyContent: "center", gap: "15px", flexWrap: "wrap" }}>
                                <button className="btn btn-primary" onClick={() => scrollToSection('projets')}>
                                    Voir mes Projets
                                </button>
                        ...
                        <div className="contact-container">
                            <div className="contact-info">
                                ...
                                <div className="social-icons">
                                    {/* 🔹 LinkedIn */}
                                    <a
                                        href="https://www.linkedin.com/in/https://www.linkedin.com/in/joris-payen-19b747395/"
                                        target="_blank"
                                    ...
                                    {/* 🔹 NewGenesis */}
                                    <a
                                        href="https://www.newgenesis.ai"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="social-icon"
                                        aria-label="NewGenesis"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <circle cx="12" cy="12" r="10"></circle>
